...
_"The world would be a safer place if people didn't do dangerous things."_
...
Considering how many dice get rolled, such flurries of action can already take a fair amount of time to resolve, so breaking the time down finer than that is generally not worth doing. When the action gets to even slower parts like cross-city chases and boat maneuvers, we pull out of combat time altogether.
